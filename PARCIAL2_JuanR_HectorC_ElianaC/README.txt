ELABORADO POR: Juan Carlos Ruales Caicedo <juancarcaicedo@unicauca.edu.co>
  ...
  inicia una conexion de chat al servidor ubicado en la direccion IP_SERVIDOR,en el puerto especificado.
	si no se especifica, la conexion se realizara en el puerto 50000
~                
